<%@ Page Title="" Language="C#" MasterPageFile="~/frontend.Master" AutoEventWireup="true" CodeBehind="TheoreticalCS.aspx.cs" Inherits="eLibrary.sections.TheoreticalCS" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">

</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <br/><br/>
    <h2>Section: Theoretical computer Science</h2>
    <br/><hr>
